...
<body>
    ...
    <header>
        ...
        <?php endif; ?>
        <div class="threebar">
            <button class="threebar1" onclick="threebar()"><img src="../images/icon/threebar.svg"
    ...
    <div class="fixed-buttons" id="fixed-buttons">
        ...
        <button onclick="closePopup(),window.location.href='https://tenze.gitbook.io/rule-book'">Rules</button>
        <button onclick="closePopup(),window.location.href='premium.php'">Premium Plans</button>
        <button onclick="closePopup(),window.location.href='https://discord.gg/fgZBCJaxAW'">Announcement</button>
        <?php
        if (!isset($_COOKIE['userid']) || !isset($_COOKIE['username']) || !isset($_COOKIE['avatarurl'])): ?>
            <button id="login" onclick="redirectToDiscord()" style="display:block;">Log In</button>
        <?php endif; ?>
    </div>
    <main>
        <div class="main">
            ...
            <center><button class="mainbutton" ontouchstart="getuserip()" onclick="getuserip()">Verify IP</button></center>
        </div>
    </main>
    <div class="startplay">
        <div class="how" id="how">
            ...
            <div class="joincontainer">
                ...
                <div class="joinmainbox step4">
                    ...
                    <button class="mainbutton2" onclick="window.location.href='premium.php'">
                        <img src="../images/icon/display-solid.svg" alt="display solid" width="20px"
                            height="20px">&nbsp;&nbsp;Premium Plans</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="gallcenter">
        <button class="galleryopen mainbutton2" onclick="showgallery()"> <img
